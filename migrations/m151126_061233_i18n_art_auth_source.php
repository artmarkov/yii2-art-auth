...
class m151126_061233_i18n_art_auth_source extends SourceMessagesMigration
{
    ...
    public function getMessages()
    {
        return [
            ...
            'E-mail' => 1,
            'Forgot password?' => 1,
            'Follow the link below to confirm your email:' => 1,
            'Follow the link below to reset your password:' => 1,
            'Follow this link to confirm your E-mail and activate account:' => 1,
            'Hello, {username}.' => 1,
            'Hello, you have been registered on {host}.' => 1,
            ...
            'The username should contain only Latin letters, numbers and the following characters: "_".' => 1,
